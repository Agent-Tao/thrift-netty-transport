...
{
    private ByteBufAllocator pooledAlloc = PooledByteBufAllocator.DEFAULT;
    ...
    public TMemoryTransport(Channel channel,
                            ByteBuf in)
    {
        this.channel = channel;
        this.in = in;
        this.out = pooledAlloc.buffer(DEFAULT_OUTPUT_BUFFER_SIZE);
    ...
    public TMemoryTransport(Channel channel, ThriftMessage message)
    {
        this(channel, message.getMessage());
    }
