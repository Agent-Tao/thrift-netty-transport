...
public final class HeaderTransport
{
     ...
     */
    public static ByteBuf encodeFrame(ThriftMessage frame)
    {
        try {
     ...
     */
    public static ThriftMessage decodeFrame(ByteBuf buffer)
    {
        ...
        try {
            ...
            return new ThriftMessage(frameSequenceId, message, allHeaders.build(), Transport.HEADER, protocol, outOfOrderResponse);
        }
        finally {
